...
const Page = () => {
  return <Container fluid>
            <PageTitle title="Naukari" subtitle="A premium collection of elegant, accessible components and a powerful codebase. Built for modern frameworks. Developer Friendly. Production Ready." badge={{
