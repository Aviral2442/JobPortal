...
exports.createJobCategory = async (req, res) => {
  try {
    ...
    if (!req.file) {
      return res
        .status(400)
        .json({ status: false, message: "Category image is required" });
    }
...
exports.updateJobCategory = async (req, res) => {
  try {
    ...
    if (result.status === 404) {
      return res
        .status(404)
        .json({ status: false, message: "Job category not found" });
    }
...
exports.getJobCategoryListUsingSectorId = async (req, res) => {
  try {
    ...
    const result =
      await JobCategoryService.getJobCategoryListUsingSectorId(sectorId);
    res.status(200).json({
      status: 200,
      message: "Job category list fetched successfully",
    ...
    console.error(
      "Error in getJobCategoryListUsingSectorId Controller:",
      error,
    );
    res.status(500).json({
      status: 500,
  ...
  try {
    ...
    if (!subcategory_category_id) {
      return res
        ...
        .json({
          status: false,
          message: "Subcategory category ID is required",
        });
    }
    ...
    if (!subcategory_name) {
      return res
        .status(400)
        .json({ status: false, message: "Subcategory name is required" });
    }

    if (!req.file) {
      return res
        .status(400)
        .json({ status: false, message: "Subcategory image is required" });
    }
...
exports.updateJobSubCategory = async (req, res) => {
  try {
    ...
    const result = await JobCategoryService.updateJobSubCategory(
      subcategoryId,
      updateData,
    );
    ...
    if (result.status === 404) {
      return res
        .status(404)
        .json({ status: false, message: "Job subcategory not found" });
    }
...
exports.getSubCategoryListUsingCategoryId = async (req, res) => {
  try {
    ...
    const result =
      await JobCategoryService.getSubCategoryListUsingCategoryId(categoryId);
    res.status(200).json({
      status: 200,
      message: "Job subcategory list fetched successfully",
      jsonData: result.jsonData,
    ...
    console.error(
      "Error in getSubCategoryListUsingCategoryId Controller:",
      error,
    );
    res.status(500).json({
      status: 500,
...
exports.upcommingJobForStudents = async (req, res) => {
  try {
    const studentId = req.params.studentId;
    const response =
      await JobCategoryService.upcommingJobForStudents(studentId);
    return res.status(response.status).json({
      status: response.status,
      message: response.message,
      jsonData: response.jsonData || null,
...
exports.updateJobStatus = async (req, res) => {
  try {
    ...
    const response = await JobCategoryService.updateJobStatus(
      jobId,
      updateColumnName,
      updateValue,
    );
...
exports.bulkUpdateJobStatus = async (req, res) => {
  try {
    ...
    const response = await JobCategoryService.bulkUpdateJobStatus(
      jobIds,
      updateColumnName,
      updateValue,
    );
...
exports.recommendJobsForStudent = async (req, res) => {
  try {
    const studentId = req.params.studentId;
    const response =
      await JobCategoryService.recommendJobsForStudent(studentId);
    return res.status(response.status).json({
      status: response.status,
      message: response.message,
      jsonData: response.jsonData || null,
...
exports.governmentAndPsuSectorJobList = async (req, res) => {
  try {
    const result = await JobCategoryService.governmentAndPsuSectorJobList(
      req.query,
    );
    res.status(200).json(result);
  } catch (error) {
...
exports.getAdmitCardListByStudentId = async (req, res) => {
  try {
    const studentId = req.params.studentId;
    const response =
      await JobCategoryService.getAdmitCardListByStudentId(studentId);
    return res.status(response.status).json({
      status: response.status,
      message: response.message,
      jsonData: response.jsonData || null,
...
exports.updateAdmitCard = async (req, res) => {
  try {
    const admitCardId = req.params.admitCardId;
    const updateData = req.body;
    const result = await JobCategoryService.updateAdmitCard(
      admitCardId,
      updateData,
    );
    return res.status(result.status).json(result);
...
exports.updateAnswerKey = async (req, res) => {
  try {
    const answerKeyId = req.params.answerKeyId;
    const updateData = req.body;
    const result = await JobCategoryService.updateAnswerKey(
      answerKeyId,
      updateData,
    );
    return res.status(result.status).json(result);
...
exports.updateDocument = async (req, res) => {
  try {
    ...
    const updateData = req.body;
    const result = await JobCategoryService.updateDocument(
      documentId,
      updateData,
    );
    return res.status(result.status).json(result);
...
exports.jobStudyMaterialListService = async (req, res) => {
  try {
    const result = await JobCategoryService.jobStudyMaterialListService(
      req.query,
    );
...
exports.getJobStudyMaterialById = async (req, res) => {
  try {
    const studyMaterialId = req.params.studyMaterialId;
    console.log("Study Material ID:", studyMaterialId); 
    const result = await JobCategoryService.getJobStudyMaterialById(studyMaterialId);
    return res.status(result.status).json(result);
  } catch (error) {
    return res
      .status(500)
...
exports.updateJobStudyMaterial = async (req, res) => {
  try {
    const studyMaterialId = req.params.studyMaterialId;
    const updateData = req.body;
    console.log("Study Material ID:", studyMaterialId);
    console.log("Update Data:", updateData);
    const result = await JobCategoryService.updateJobStudyMaterial(
      studyMaterialId,
      updateData,
    );
    return res.status(result.status).json(result);
...
exports.deleteJobStudyMaterial = async (req, res) => {
  try {
    const studyMaterialId = req.params.studyMaterialId;
    const result = await JobCategoryService.deleteJobStudyMaterial(studyMaterialId);
    return res.status(result.status).json(result);
  } catch (error) {
    return res
      .status(500)
